...
<head>
    ...
    <style>
        body {
            background-image: url('images/clinical mang2.jpg'); /* Replace with a nurse-friendly background image */
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="submenu">
                        <a href="#">Medication Administration</a>
                        <a href="#">Medication Records</a>
                        <a href="#">Request Refill</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
    ...
    <div class="right-frame">
        <div id="welcome-frame" class="right-frame">
            <h3>Welcome, <span id="username"><?php echo htmlspecialchars($nurse_username); ?></span>!</h3>
        </div>
    </div>
