...
$patient_username = $_SESSION['username']; // Assuming username is stored in the session
$query = "SELECT patient_name FROM patients WHERE username = ?"; // Replace `username` with the correct identifier if necessary
$stmt = $conn->prepare($query);
$stmt->bind_param("s", $patient_username);
$stmt->execute();
$result = $stmt->get_result();
$row = $result->fetch_assoc();
$patient_name = $row['patient_name'] ?? 'Patient'; // Fallback to 'Patient' if name is not found
?>
...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <div class="submenu" id="prescriptions-submenu">
            <a href="" target="content-frame"><i class="fas fa-eye"></i> View Prescriptions</a>
        ...
        function loadDashboard() {
            ...
            document.getElementById("content-frame").srcdoc = `
                ...
                <div class="image-container">
                    <img src="images/clinical_mang2.jpg" alt="Sample Image">
                    <div class="overlay"></div>
                    <div class="content">Welcome, ${patientName}!</div>
                </div>
                </body>
                </html>
            `;
